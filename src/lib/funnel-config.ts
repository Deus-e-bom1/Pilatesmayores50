...
export const funnelConfig = {
  ...
  checkoutUrl: env["VITE_CHECKOUT_URL"] ?? "https://pay.hotmart.com/X107662105Q",

  /** Segundos de video antes de mostrar el botón de compra (3:30 = 210s). */
  ctaDelaySeconds: Number(env["VITE_CTA_DELAY_SECONDS"] ?? 210),
